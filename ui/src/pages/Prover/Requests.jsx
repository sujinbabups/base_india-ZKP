...
const Requests = () => {
  ...
  return (
    <div className='pt-[5%]'>
    <button className='w-[250px] h-10 bg-[#00bcd4] text-center text-xl font-bold text-white border-white border-[3px] rounded-full ml-16 mt-5'>
      scan qrcode
    </button>
    <div className='text-center lg:mt-0 mt-[10%] text-2xl font-bold text-[#e1e1e6]'>REQUESTS PENDING</div>
          ...
          {data.map((item) => (
            <tr key={item.ID} className="border-t border-gray-300 text-black">
              ...
              <td className="px-4 py-2 text-center">
                <div href={item.View} className="text-[#00bcd4] hover:underline">
